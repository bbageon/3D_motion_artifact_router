...
|---|---|---|---|---|
| AR-066 | Evaluator | Intent-aware float weighting — floating 판정을 text intent 로 조건화 (Tier 0 지속시간 가중 → Tier 1 prompt bucket 층화 → Tier 2 학습 estimator). float 정의 변별력 부족(clean p99 0.70) 해소 | 🟠 | 사용자 제안 2026-07-07. [spec](../docs/dashboard-task-specs/AR-066-intent-aware-float-weighting.md). AR-058-3f human 라벨을 validation 으로 사용 예정 |
