...
|---|---|---|---|---|
| AR-050 | Generator | MotionGPT length-control failure audit — exact 21.9%/<0.6 10.9%, 4-frame upstream 확정(011743 seed=[4,188,188]). **원인 코드 확정**: generate_direct에 batch length 미전달→확률적 EOS. protocol: native primary + sensitivity 분리 | 06-09 | 67c1f4d · [snapshot](../../evals/snapshots/motiongpt_length_audit_v1.json) · [일지](../../reports/2026-06-09.md) |
