...
|---|---|---|---|---|
| AR-043 | Evidence | Dataset predefined issue prevalence audit — stress/natural 4.1x + evaluator 신뢰도 등급(reliable=FootFloating 1) + ar040_decision=GO+조건4 (5조건 충족) | 06-03 | (본 commit) |
