...
|---|---|---|---|---|---|
| AR-020 | Evidence | **가설 status 정리 (H-203/204/205/206 통합 검토)** — 새 증거 체계(E1~E11)로 5단계 평가 + status/supersede draft. 전환 = §3-11 사용자 게이트 | 🟠 | 07-13 | 원 AR-020(H-205 검토)을 4건 통합으로 확장. 구증거 결함(v0.1.0 무신호 feature·Cat-C currency) 반영 |
