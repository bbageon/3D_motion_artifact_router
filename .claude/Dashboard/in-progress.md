...
|---|---|---|---|---|---|
| AR-024 | Evidence | **독립 pool 재현 착수** — 새 base-seed 20260719, 동일 300 prompt bank × 3 gen × 3 seed 생성 (docker 서비스 경유, detach 실행). 완료 후 핵심 결과 재측정 (Cat-A pool-scoped → 재현) | 🔴 | 07-19 | 논문 요건 ③. log: external_assets/protocol_rep_pool_seed20260719/generation.log |
| AR-084 | Evidence | 신규성 sweep — **판정: 핵심 신규성 유지** (MDM root 상수-붕괴 정량 진단 + 사슬은 미보고로 판단), 단 contact 기반 root 재구성 방법 조각은 Li et al. 2024 계열 인용 필수. "최초" 표현 금지 → "to our knowledge + 인용 대비" | 🟠 | 07-19 | [report](../../evals/reports/2026-07-19_novelty_sweep_ar084.md). 남은 확인 2건 (Li 원문·GMD 계열 서론) |
