...
|---|---|---|---|---|
| AR-058-3i | Perceptual | **A/B v2 — pack 완성(3eec6de, 실속도 재렌더 5041fa5), 사용자 판정 대기** (20쌍, ~10분, **마지막 재검정**). [index](../../reports/figures/2026-07-12/ar058_3i_ab_v2_pack/index.md) → [rater_sheet.csv](../../reports/figures/2026-07-12/ar058_3i_ab_v2_pack/rater_sheet.csv). ⚠️ answer_key 판정 전 열람 금지 | 🔴 | 기준: ≥15/20 지지 / **≤12/20 → Stop 방향** / 13~14 → b2. combo 물리: fs −48% 20/20, legCV 전쌍 0, float +0.016 공시. [prereg](../../evals/snapshots/ab_preference_pack_v2_ar058_3i_v1.json) |
