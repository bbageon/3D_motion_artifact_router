...
| AR-045 | Generator | MoMask 확보 → masked-token generator pool 구축 | 🟠 | acquisition + smoke OK (prelim, 우열 미확정). AR-048 freeze 완료. 큰 pool 규모는 **AR-049 tiered**(soft 50 / hard 300) 기준. CVPR 2024. [spec](../docs/dashboard-task-specs/AR-045-momask-generator-acquisition.md) |
